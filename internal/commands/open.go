...
func createPostMortemAndUpdateTopic(ctx context.Context, logger log.Logger, client bot.Client, fileStorage filestorage.Driver, incidentID int64, CommanderID, repository model.Repository, channel *slack.Channel, warRoomURL string) {
	...
	topic.WriteString("*Incident Commander:* @" + CommanderID + "\n\n")
